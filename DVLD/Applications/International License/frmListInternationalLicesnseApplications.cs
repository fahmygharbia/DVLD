...
namespace DVLD.Applications.International_License
{
    public partial class frmListInternationalLicesnseApplications : Form
    {
        ...
        {
            InitializeComponent();
            SaveEventLog($"Form International License Applications is opened at {DateTime.Now}", EventLogEntryType.Information);
        }

        private void btnClose_Click(object sender, EventArgs e)
        {
            SaveEventLog("From International License Applications is closed " + DateTime.Now, EventLogEntryType.Information);
            this.Close();
        }
