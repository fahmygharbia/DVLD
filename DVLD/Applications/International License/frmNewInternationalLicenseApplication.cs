...
namespace DVLD.Applications.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        {
            InitializeComponent();
            SaveEventLog($"Form International License Application at {DateTime.Now}", EventLogEntryType.Information);
        }
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            {
                SaveEventLog($"Form: International License Application\n" +
                    $"Selected License should be Class 3, select another one.", EventLogEntryType.Error);
            ...
            {
                SaveEventLog($"Form: International License Application\n Person already has an active international license with ID = {ActiveInternaionalLicenseID.ToString()}", EventLogEntryType.Error);
        ...
        {
            SaveEventLog("Form International License Application\n This form is closed at " + DateTime.Now, EventLogEntryType.Error);
            this.Close();
        }
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            ...
            {
                SaveEventLog($"Form International License Application\n Faild to Issue International License", EventLogEntryType.Error);
