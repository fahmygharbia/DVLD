...
namespace DVLD_Business
{
    public class clsUser
    {
        ...
        private bool _AddNewUser()
        {
            ...
            this.Password = clsEncryption.ComputeHashPassword(this.Password);
        ...
        {
            Password = clsEncryption.ComputeHashPassword(Password);
        ...
        public static string PasswordAfterEncryption(string password)
        {
            return clsEncryption.ComputeHashPassword(password);
        }
    }
}
